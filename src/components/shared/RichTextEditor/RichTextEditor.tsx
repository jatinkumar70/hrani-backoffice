...
const RichTextEditor = (props: RichTextEditorProps) => {
    ...
    const editor = customEditor
        ...
        : useEditor({
              ...
              editorProps: {
                  attributes: {
                      class: 'm-2! focus:outline-hidden min-h-[100px] cursor-text',
                  },
              },
              content,
              onUpdate({ editor }) {
    ...
    return (
        <div
            className={classNames(
                'rich-text-editor rounded-xl ring-1 ring-gray-200 dark:ring-gray-600 border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 pt-3',
        ...
        >
            <div className="flex gap-x-1 gap-y-2 px-2 overflow-x-auto">
                {customToolBar ? (
