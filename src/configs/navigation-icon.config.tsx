...
import { MdLeaderboard, MdOutlineInventory } from 'react-icons/md'
...
const navigationIcon: NavigationIcons = {
    ...
    promocode: <BiSolidDiscount />,
    roleGroups: <HiOutlineUserGroup />,
    securtiy: <PiSecurityCameraDuotone />,
    property: <PiHouseLineDuotone />,
    enquiry: <MdLeaderboard />,
    inventory: <MdOutlineInventory />,
    map: <PiMapTrifoldDuotone />,
    formula: <PiFunctionDuotone />,
}
