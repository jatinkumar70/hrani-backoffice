...
const conceptsNavigationConfig: NavigationTree[] = [
    {
        ...
        subMenu: [
                ...
                subMenu: [
                    {
                        ...
                        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/ai/chat`,
                        title: 'Chat',
                    ...
                    },
                    {
                        ...
                        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/ai/image`,
                        title: 'Image',
                ...
                subMenu: [
                    {
                        ...
                        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/projects/scrum-board`,
                        title: 'Scrum Board',
                    ...
                    },
                    {
                        ...
                        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/projects/project-list`,
                        title: 'Project List',
                    ...
                    },
                    {
                        ...
                        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/projects/project-details/27`,
                        title: 'Details',
                    ...
                    },
                    {
                        ...
                        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/projects/tasks`,
                        title: 'Tasks',
                    ...
                    },
                    {
                        ...
                        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/projects/tasks/1`,
                        title: 'Issue',
                ...
                subMenu: [
                    {
                        ...
                        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/customers/customer-list`,
                        title: 'Customer List',
                    ...
                    },
                    {
                        ...
                        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/customers/customer-edit/1`,
                        title: 'Customer Edit',
                    ...
                    },
                    {
                        ...
                        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/customers/customer-create`,
                    ...
                    },
                    {
                        ...
                        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/customers/customer-details/1`,
                ...
                subMenu: [
                    {
                        ...
                        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/products/product-list`,
                        title: 'Product List',
                    ...
                    },
                    {
                        ...
                        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/products/product-edit/12`,
                        title: 'Product Edit',
                    ...
                    },
                    {
                        ...
                        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/products/product-create`,
                ...
                subMenu: [
                    {
                        ...
                        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/orders/order-list`,
                        title: 'Order List',
                    ...
                    },
                    {
                        ...
                        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/orders/order-edit/95954`,
                        title: 'Order Edit',
                    ...
                    },
                    {
                        ...
                        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/orders/order-create`,
                        title: 'Order Create',
                    ...
                    },
                    {
                        ...
                        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/orders/order-details/95954`,
                        title: 'Order Details',
                ...
                subMenu: [
                    {
                        ...
                        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/account/settings`,
                        title: 'Settings',
                    ...
                    },
                    {
                        ...
                        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/account/activity-log`,
                        title: 'Activity log',
                    ...
                    },
                    {
                        ...
                        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/account/roles-permissions`,
                    ...
                    },
                    {
                        ...
                        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/account/pricing`,
                        title: 'Pricing',
                ...
                subMenu: [
                    {
                        ...
                        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/help-center/support-hub`,
                        title: 'Support Hub',
                    ...
                    },
                    {
                        ...
                        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/help-center/article/pWBKE_0UiQ`,
                        title: 'Article',
                    ...
                    },
                    {
                        ...
                        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/help-center/edit-article/pWBKE_0UiQ`,
                        title: 'Edit Article',
                    ...
                    },
                    {
                        ...
                        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/help-center/manage-article`,
            ...
            },
            {
                ...
                path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/calendar`,
                title: 'Calendar',
            ...
            },
            {
                ...
                path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/file-manager`,
                title: 'File Manager',
            ...
            {
                key: 'concepts.mail',
                path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/mail`,
                title: 'Mail',
            ...
            {
                key: 'concepts.chat',
                path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/chat`,
                title: 'Chat',
