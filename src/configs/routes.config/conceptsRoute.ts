...
const conceptsRoute: Routes = [
    ...
    },
    {
        ...
        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/customers/customer-edit/:id`,
        component: lazy(
    ...
    },
    {
        ...
        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/customers/customer-details/:id`,
        component: lazy(
    ...
    },
    {
        ...
        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/products/product-edit/:id`,
    ...
    },
    {
        ...
        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/projects/project-details/:id`,
        component: lazy(
    ...
    },
    {
        ...
        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/projects/tasks/:id`,
    ...
    },
    {
        ...
        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/orders/order-edit/:id`,
    ...
    },
    {
        ...
        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/orders/order-details/:id`,
    ...
    },
    {
        ...
        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/help-center/article/:id`,
    ...
    },
    {
        ...
        path: `${APP_BASE_ROUTE["app"]}${CONCEPTS_PREFIX_PATH}/help-center/edit-article/:id`,
        component: lazy(
