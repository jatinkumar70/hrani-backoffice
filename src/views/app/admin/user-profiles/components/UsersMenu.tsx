...
import { TbUserSquare, TbLock } from 'react-icons/tb'

import type { ReactNode } from 'react'
import { View } from '@/views/concepts/accounts/Settings/types'
import { useSettingsStore } from '@/views/concepts/accounts/Settings/store/settingsStore'
// import BottomStickyBar from '@/components/template/BottomStickyBar'
// import TopStickyBar from '@/components/template/TopStickyBar'
...
export const UsersMenu = ({ onChange }: { onChange?: () => void }) => {
